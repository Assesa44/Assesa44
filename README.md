...
<p align="center">
  💡 Data Scientist • 🔍 Insight Hunter • 💻 Passionate about storytelling through data
</p>
...
I’m a curious and driven data scientist with a passion for transforming messy data into meaningful stories. Whether I’m scraping product reviews, visualizing trends, or applying NLP to uncover customer sentiment, I bring persistence, creativity, and a love for learning into every project.
...
Built a classificaton model to predict whether a water point (well) is functional, not functional or needs repair. Includes EDA, feature engineering, and thoughtful storytelling.
